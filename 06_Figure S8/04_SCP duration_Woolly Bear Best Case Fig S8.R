...
# best-case scenario for days under the SCP of Woolly Bears.
...
# Jpgs produced:
# SCP_WoollyBear_Mean_External_Best.jpg
# SCP_WoollyBear_Mean_3C_warmer_Best.jpg
# SCP_WoollyBear_Mean_5C_warmer_Best.jpg
...
# setwd("Y:/kthompson/Ch 4 Bumblebees/Spatial Predictions/Species Sensitivities/Wooly Bear")

dur0_mean <- raster :: raster("SCP_Wooly Bear_Mean_External.tif")
dur3_mean <- raster :: raster("SCP_Wooly Bear_Mean_3C warmer.tif")
dur5_mean <- raster :: raster("SCP_Wooly Bear_Mean_5C warmer.tif")

dur0_median <- raster :: raster("SCP_Wooly Bear_Median_External.tif")
dur3_median <- raster :: raster("SCP_Wooly Bear_Median_3C warmer.tif")
dur5_median <- raster :: raster("SCP_Wooly Bear_Median_5C warmer.tif")

dur0_min <- raster :: raster("SCP_Wooly Bear_Minimum_External.tif")
dur3_min <- raster :: raster("SCP_Wooly Bear_Minimum_3C warmer.tif")
dur5_min <- raster :: raster("SCP_Wooly Bear_Minimum_5C warmer.tif")

dur0_max <- raster :: raster("SCP_Wooly Bear_Maximum_External.tif")
dur3_max <- raster :: raster("SCP_Wooly Bear_Maximum_3C warmer.tif")
dur5_max <- raster :: raster("SCP_Wooly Bear_Maximum_5C warmer.tif")
...
# path <- "L:/LabMemberFolders/KimberlyThompson/Ch 4 Bumblebees/Analysis/Graphs/Species Sensitivities/Wooly Bear"
setwd(path)
