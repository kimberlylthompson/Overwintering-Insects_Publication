...
# best-case scenario for days under the SCP of P. canadensis.
...
# Jpgs produced:
# SCP_P canadensis_Mean_External_Best.jpg
# SCP_P canadensis_Mean_3C_warmer_Best.jpg
# SCP_P canadensis_Mean_5C_warmer_Best.jpg
...
setwd("01_Analysis/Spatial Predictions/Species Vulnerability/Papilio candensis")
# setwd("Y:/kthompson/Ch 4 Bumblebees/Spatial Predictions/Species Sensitivities/Papilio canadensis")

dur0_mean <- raster :: raster("SCP_P.canadensis_Mean_External.tif")
dur3_mean <- raster :: raster("SCP_P.canadensis_Mean_3C warmer.tif")
dur5_mean <- raster :: raster("SCP_P.canadensis_Mean_5C warmer.tif")

dur0_median <- raster :: raster("SCP_P.canadensis_Median_External.tif")
dur3_median <- raster :: raster("SCP_P.canadensis_Median_3C warmer.tif")
dur5_median <- raster :: raster("SCP_P.canadensis_Median_5C warmer.tif")

dur0_min <- raster :: raster("SCP_P.canadensis_Minimum_External.tif")
dur3_min <- raster :: raster("SCP_P.canadensis_Minimum_3C warmer.tif")
dur5_min <- raster :: raster("SCP_P.canadensis_Minimum_5C warmer.tif")

dur0_max <- raster :: raster("SCP_P.canadensis_Maximum_External.tif")
dur3_max <- raster :: raster("SCP_P.canadensis_Maximum_3C warmer.tif")
dur5_max <- raster :: raster("SCP_P.canadensis_Maximum_5C warmer.tif")
...
# path <- "L:/LabMemberFolders/KimberlyThompson/Ch 4 Bumblebees/Analysis/Graphs/Species Sensitivities/Papilio canadensis"
setwd(path)
