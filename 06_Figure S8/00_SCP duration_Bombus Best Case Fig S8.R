...
# best-case scenario for days under the SCP of bumblebees.
...
# Jpgs produced:
# SCP_Bombus_Mean_External_Best.jpg
# SCP_Bombus_Mean_3C_warmer_Best.jpg
# SCP_Bombus_Mean_5C_warmer_Best.jpg
...
dur0_mean <- raster :: raster("SCP_Bombus_Mean_External.tif")
dur3_mean <- raster :: raster("SCP_Bombus_Mean_3C warmer.tif")
dur5_mean <- raster :: raster("SCP_Bombus_Mean_5C warmer.tif")

dur0_median <- raster :: raster("SCP_Bombus_Median_External.tif")
dur3_median <- raster :: raster("SCP_Bombus_Median_3C warmer.tif")
dur5_median <- raster :: raster("SCP_Bombus_Median_5C warmer.tif")

dur0_min <- raster :: raster("SCP_Bombus_Minimum_External.tif")
dur3_min <- raster :: raster("SCP_Bombus_Minimum_3C warmer.tif")
dur5_min <- raster :: raster("SCP_Bombus_Minimum_5C warmer.tif")

dur0_max <- raster :: raster("SCP_Bombus_Maximum_External.tif")
dur3_max <- raster :: raster("SCP_Bombus_Maximum_3C warmer.tif")
dur5_max <- raster :: raster("SCP_Bombus_Maximum_5C warmer.tif")
...
# path <- "L:/LabMemberFolders/KimberlyThompson/Ch 4 Bumblebees/Analysis/Graphs/Species Sensitivities/Bumblebees"
setwd(path)
