<<<<<<< HEAD
###########################################################################
###########      Figures for SCP Sensitivity in Bean Leaf Beetle        ########
...
# worst-case scenario for days under the SCP of Bean Leaf Beetles.
...
# Jpgs produced:
# SCP_BeanLeaf_Worst_Case_Mean_External.jpg
# SCP_BeanLeaf_Worst_Case_Mean_3C_warmer.jpg
# SCP_BeanLeaf_Worst_Case_Mean_5C_warmer.jpg
...
# path <- "L:/LabMemberFolders/KimberlyThompson/Ch 4 Bumblebees/Analysis/Graphs/Species Sensitivities/Bean Leaf Beetle/Worst Case"
setwd(path)

for (i in nlayers(rasterlist)) {
  
  file.name <- paste(names(rasterlist)[[i]], "_BeanLeaf.jpg", sep="")
